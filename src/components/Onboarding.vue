...
const localization: Record<string, Record<string, string>> = {
  ...
  ar: {
    back: "رجوع",
    lvlTitle: "ما هو مستواك في اللغة الإنجليزية؟",
    lvlSubtitle: "دعنا نبدأ بالمحتوى المناسب لك",
    lvlBeg: "مبتدئ",
    lvlBegDesc: "أبدأ من الصفر",
    lvlInt: "متوسط",
    lvlIntDesc: "أعرف بعض الأشياء، أريد التقدم",
    lvlAdv: "متقدم",
    lvlAdvDesc: "أقرأ الإنجليزية بشكل جيد بالفعل",
    nameTitle: "اختر اسمك المستعار",
    nameSubtitle: "هكذا سيظهر اسمك في التطبيق",
    checking: "جاري التحقق من الاسم المستعار...",
    available: "متاح ✓",
    continue: "متابعة",
  },
  pt: {
    back: "Voltar",
    lvlTitle: "Qual o seu nível de inglês?",
    lvlSubtitle: "Vamos começar com o conteúdo certo para você",
    lvlBeg: "Iniciante",
    lvlBegDesc: "Começo do zero",
    lvlInt: "Intermédio",
    lvlIntDesc: "Sei alguma coisa, quero avançar",
    lvlAdv: "Avançado",
    lvlAdvDesc: "Já leio bem em inglês",
    nameTitle: "Escolha seu apelido",
    nameSubtitle: "Assim aparecerá seu nome na aplicação",
    checking: "Verificando apelido...",
    available: "Disponível ✓",
    continue: "Continuar",
  },
  fr: {
    back: "Retour",
    lvlTitle: "Votre niveau d'anglais ?",
    lvlSubtitle: "Commençons avec le bon contenu pour vous",
    lvlBeg: "Débutant",
    lvlBegDesc: "Je commence à partir de zéro",
    lvlInt: "Intermédiaire",
    lvlIntDesc: "Je connais les bases, je veux progresser",
    lvlAdv: "Avancé",
    lvlAdvDesc: "Je lis déjà bien l'anglais",
    nameTitle: "Choisissez votre pseudo",
    nameSubtitle: "C'est ainsi que votre nom apparaîtra",
    checking: "Vérification du pseudo...",
    available: "Disponible ✓",
    continue: "Continuer",
  },
  de: {
    back: "Zurück",
    lvlTitle: "Ihr Englisch-Niveau?",
    lvlSubtitle: "Lassen Sie uns mit den passenden Inhalten starten",
    lvlBeg: "Anfänger",
    lvlBegDesc: "Ich fange ganz von vorne an",
    lvlInt: "Mittelstufe",
    lvlIntDesc: "Ich weiß etwas, möchte weiterkommen",
    lvlAdv: "Fortgeschritten",
    lvlAdvDesc: "Ich kann bereits gut Englisch lesen",
    nameTitle: "Wählen Sie Ihren Spitznamen",
    nameSubtitle: "So wird Ihr Name in der App angezeigt",
    checking: "Spitzname wird überprüft...",
    available: "Verfügbar ✓",
    continue: "Weiter",
  },
  it: {
    back: "Indietro",
    lvlTitle: "Il tuo livello di inglese?",
    lvlSubtitle: "Iniziamo con il contenuto giusto per te",
    lvlBeg: "Principiante",
    lvlBegDesc: "Parto da zero",
    lvlInt: "Intermedio",
    lvlIntDesc: "So qualcosa, voglio avanzare",
    lvlAdv: "Avanzato",
    lvlAdvDesc: "Leggo già bene l'inglese",
    nameTitle: "Scegli il tuo nickname",
    nameSubtitle: "Così apparirà il tuo nome nell'app",
    checking: "Verifica del nickname...",
